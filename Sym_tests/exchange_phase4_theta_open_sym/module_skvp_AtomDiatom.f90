...
!
 ...
 COMPLEX(8), ALLOCATABLE, DIMENSION(:,:)        :: BAM_x1_sym, BAM_x3_sym, BAM_x4_sym
 COMPLEX(8), ALLOCATABLE, DIMENSION(:,:)        :: BAM_xx1, BAM_xx2, BAM_xx3, BAM_xx4, mat_B, mat_C, Smat, BAM_r101, BAM_r102
 COMPLEX(8), ALLOCATABLE, DIMENSION(:,:)        :: BAM_xx1_sym, BAM_xx3_sym, BAM_xx4_sym
 ...
 COMPLEX(8), ALLOCATABLE, DIMENSION(:,:)        :: BAM_xx1b_sym, BAM_xx3b_sym, BAM_xx4b_sym
	 COMPLEX(8), ALLOCATABLE, DIMENSION(:,:)        :: mat_M0, mat_M10, mat_M00, M0_V, M10_V2, M_V2, BAM_r01, BAM_r02, BAM_r03
         COMPLEX(8), ALLOCATABLE, DIMENSION(:,:)        :: mat_M0_sym, mat_M00_sym, mat_M10_sym, Smat_sym
 REAL(8), ALLOCATABLE, DIMENSION(:)             :: gq_weight_x, gq_root_x, norm, knots_x, norm_vec
 REAL(8), ALLOCATABLE, DIMENSION(:)             :: gq_weight_y, gq_root_y, eval1d, kvec, sym_kvec, x, wx
	 REAL(8), ALLOCATABLE, DIMENSION(:,:)           :: M_V
         REAL(8), ALLOCATABLE, DIMENSION(:,:)           :: mat_M_sym
 ...
 REAL(8), ALLOCATABLE, DIMENSION(:,:)           :: BAM_theta002, BAM_theta100, BAM_theta101, BAM_theta102, mat_M
	INTEGER, ALLOCATABLE, DIMENSION(:,:)           :: quant_mat
        INTEGER                                        :: nsym, n_sym_open
        INTEGER, ALLOCATABLE, DIMENSION(:,:)           :: sym_quant_mat
        INTEGER, ALLOCATABLE, DIMENSION(:,:)           :: sym_old_idx
        REAL(8), ALLOCATABLE, DIMENSION(:,:)           :: sym_coeff
        INTEGER, ALLOCATABLE, DIMENSION(:)             :: sym_ncomp
        INTEGER, ALLOCATABLE, DIMENSION(:)             :: old_to_sym
        INTEGER, ALLOCATABLE, DIMENSION(:)             :: sym_open_idx
        INTEGER, ALLOCATABLE, DIMENSION(:)             :: old_open_pos_to_sym_open
